...
<div class="container-fluid">
    <div class="row card">
       <div class="col-md-12 text-right">
         <router-link :to="{name:'auth.permissions.add'}"  class="btn bg-gradient-primary btn-sm pl-3 pr-3">Add</router-link>
       </div>
       <div class="col-md-12">
         <input type="text" v-model="search" class="form-control form-control-sm" placeholder="Search Here">
       </div>
       <div class="col-md-12">
