...
export default {
  ...
  async mounted(){
    ...
    await countryservice.getlist('').then(e=>{
      this.countries = e.data
    })
    await stateservice.getlist('?country_id='+this.form.shipping_country).then(e=>{
        this.states = e.data
    })
    await citieservice.getlist('?state_id='+this.form.shipping_state).then(e=>{
        this.cities = e.data
    })
    await stateservice.getlist('?country_id='+this.form.billing_country).then(e=>{
        this.billing_states = e.data
    })
    await citieservice.getlist('?state_id='+this.form.billing_state).then(e=>{
        this.billing_cities = e.data
    })
    this.form = {
    ...
    this.order_discount = res.discount_amount
